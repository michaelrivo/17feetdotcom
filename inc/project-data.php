<?php
	...
	$featuredArr = array(
		array( 'pac-12', 			'Pac-12', 				'Conference site for the new Pac-12'),	
		array( 'learnist', 			'Learnist', 			'Learning made social - anywhere')
	);
	
	$projectArr = array(
		
		array( 'onelogin', 			'Onelogin', 			'All your logins in one basket'),
	...
	//	array( 'nxtm', 				'NXTM',					'Social Tool for Musicians' ),
		...
		array( 'angies-list', 		'Angie\'s List',		'Your handyman\'s favorite tool.' ),

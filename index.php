...
<div id="slider" class="nojs responsive-transition">
	...
	<div class="item slide0 responsive-transition" style="left:0%">
		<div class="bg responsive-transition"></div>
		...
		<div class="item slide4" style="left:400%">
			<div class="bg"></div>
			<div class="banner container" project="our-work/simraceway">
				<h2>Simraceway</h2>
				<h3>Web integration and commerce for a <br/>new kind of racing game.
				<br/><a class="cta" href="our-work/simraceway">View the project</a></h3>
...
<div class="container second-tier">
	...
	<div class="row">
		...
		<div class="span4 trans-black last">
			<div>

...
<div class="container copy project">
	...
	<div class="span-12 last" style="background: transparent url(../../imgs/projects/loyal3-1.png) no-repeat center center;height:520px;position:relative; top:-35px"></div>
	
	<div class="shim-80"></div>
	
	<div class="span-7 append-5 last no-pad" style="background:transparent url(../../imgs/projects/loyal3-2.png) no-repeat right 0">
	...
	<div class="shim-80" style="height:80px;"></div>
	
	<div class="span-4 no-pad">

		<h4 style="margin-top:50px;">Product Development</h4>

		<p style="width:318px;" >Once the brand work was in place we turned to the product functionality and user experience. To successfully revolutionize how people buy stocks we would have to rethink the current brokerage site experience into something designed for the average person to easily navigate.</p>
		
		<div style="background:transparent url(../../imgs/projects/loyal3-4.png) no-repeat 0 0; position:relative; width:417px; height:606px;left:-60px; margin-top:85px;"></div>
	
	</div>

	<div class="span-8 last">
	
		<div style="background:transparent url(../../imgs/projects/loyal3-3.png) no-repeat 0 0; position:relative;right:-22px; width:609px; height:529px; z-index:-1; padding:0"></div>
	
		<div class="span-6 append-1 prepend-1 last no-pad" style="margin-top:85px;">

...
<div class="container copy project">
	...
	<div class="span-5 append-7 last no-pad" style="height:998px;position:relative; margin-bottom:-70px">
		<div style="background:transparent url(../../imgs/projects/indie-film-fest.png) no-repeat 0 0; height:998px; width:789px;position:absolute;z-index:-1;top:-75px;right:-85px;"></div>
		
		<h4 style="margin-top:80px">SF Independent <br/>Film Festival</h4>
	...
	<div class="span-6" style="background:transparent url(../../imgs/projects/feeters.png) no-repeat 0 0 ;height:370px;right:-25px;top:-30px; position:relative;"></div>
	...
	<div class="span-6 graphic last" style="background-image:url(../../imgs/projects/sketchfest.png); height:480px; position:relative; left:35px;"></div>

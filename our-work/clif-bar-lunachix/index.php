...
<style type="text/css">
	#hero-graphic{
		background: transparent url(../../imgs/projects/luna-1.png) no-repeat center bottom;
		position:absolute;
		top:65px;
		height:680px;
		width:100%;
...
<div class="container copy project">
	...
	<div class="span9 append-2 prepend-1 last last ">
	...
	<div class="span12 graphic last" style="background-image:url(../../imgs/projects/luna-2.png); height:476px;"></div>
	
	<!-- row -->
	
	<div class="shim-40"></div>
	
	<div class="span6 prepend-6 last more-pad" style="height:730px;position:relative;">
		...
		<div style="background:transparent url(../../imgs/projects/luna-3.png) no-repeat 0 0;position:absolute; left:-60px; top:0; width:539px; height:730px;"></div>
	</div>

...
<div class="container project header">
	...
	<div class="span9">
		<h2>Salesforce Customer<br/>Success Stories</h2>
...
<div class="container copy project" >
	...
	<div class="graphic" style="background-image:url(../../imgs/projects/salesforce-1.png); width:1086px; height:819px; position:relative; left:-65px;"></div>
	
	
	<div class="span4 no-pad append-8 last" style="height:455px; background: transparent url(../../imgs/projects/salesforce-2.png) no-repeat right 0;">
	...
	<div class="graphic" style="height:780px; background:transparent url(../../imgs/projects/salesforce-3.png) no-repeat center center; position:relative;top:-20px"></div>

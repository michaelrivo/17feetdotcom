...
<style type="text/css">
	#hero-graphic{
		background: transparent url(../../imgs/projects/peoplebrowsr-1.png) no-repeat center 0;
		position:absolute;
		bottom:-120px;
		height:709px;
		width:100%;
...
<!-- 	<div class="span6 last no-pad">
	...
	<div class="prepend-2 span7 append-3 last no-pad">
		...
		<p>Our work on the consumer application has gone on to influence PeopleBrowsr's entire suite of marketing products and we couldn't be happier. We've continued to be involved in helping the company create a simple, cohesive experience across their entire platform.</p>

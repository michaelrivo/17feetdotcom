	...
	<table cellspacing="3" cellpadding="5" width="100%" border="0" style="border:1px solid #C3D9FF">
	  <tr>
	    <td valign="top" style="background-color:#e8eefa" >
		  ...
		  <div style="padding:5px 2px 5px 15px " >
			<ul>
				<li><a href="http://help.maxblogpress.com/spaces/maxblogpress/manuals/2204" target="_blank"  style="text-decoration:none">Online Documentation</a></li>
...
<ul>
	  ...
	  <li><a href="http://www.maxblogpress.com/365k/" target="_blank" style="text-decoration:none">The $365K Blog Traffic Formula</a></li>
		...
		<div style="padding:10px 0px 0px 15px"><strong>Get Connected With MaxBlogPress</strong></div>
			<div style="padding:5px 2px 5px 15px">
				<ul>
				  <li><a href="http://www.maxblogpress.com/facebook" target="_blank" style="text-decoration:none"><img border="0" src="<?php echo MCN_FULLPATH;?>facebook_icon.jpg" width="20" height="20" />&nbsp;Facebook</a></li>
				  <li><a href="http://www.maxblogpress.com/twitter" target="_blank" style="text-decoration:none"><img border="0" src="<?php echo MCN_FULLPATH;?>TwitterIcon.png" width="20" height="20" />&nbsp;Twitter</a></li>
				</ul>
		  </div>			
	    </td>
	  </tr>
